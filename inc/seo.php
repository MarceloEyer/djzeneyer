...
add_action('wp_head', function() {
    ...
    // CORREÇÃO PRINCIPAL: REMOVER AS QUEBRAS DE LINHA INÚTEIS E USAR CONCATENAÇÃO CORRETA
    $output = '';
...
add_action('wp_head', function() {
    ...
    // 1. MusicGroup + Person (Dados Artísticos)
    $schema_artist = [
        ...
        "logo" => $logo_url,
        "image" => $image_url,
        // CORRIGIDO: Lista de Gêneros Musicais
        "genre" => ["Brazilian Zouk", "Kizomba", "RnB", "Reggaeton", "Moombahton", "Dancehall", "Afrohouse", "Afrobeat"], 
    ...
    // 2. Organization (Dados Legais e CNPJ)
    $schema_org = [
        "@context" => "https://schema.org",
        "@type" => "Organization",
        "name" => "Zen Eyer",
