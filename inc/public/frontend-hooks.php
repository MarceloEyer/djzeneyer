<?php
/**
 * Frontend Hooks & Cleanup
 * Optimizes the frontend rendering by removing bloat and deferring scripts
 */
...
/**
 * --------------------------------------------------
 * Setup/Performance (from setup.php)
 * --------------------------------------------------
 */
