...
// ============================================================================
// 1. CONFIGURA├ç├âO DE LINKS (Centralizado para facilitar ajustes)
// ============================================================================
const PRESS_LINKS = {
  photos: "https://photos.djzeneyer.com", // Ô£à Seu subdom├¡nio personalizado
  epk: "/media/dj-zen-eyer-epk.pdf",     // ­ƒôü Coloque este arquivo em public/media/
  logos: "/media/dj-zen-eyer-logos.zip"   // ­ƒôü Coloque este arquivo em public/media/
};

// ============================================================================
// 2. CONTE├ÜDO BIL├ìNGUE
// ============================================================================

const CONTENT_PT = {
  seo: {
    title: "Press Kit Oficial - Zen Eyer | DJ Brasileiro de Zouk Brasileiro",
    description: "Press Kit oficial de Zen Eyer, DJ brasileiro bicampe├úo mundial de Zouk Brasileiro. Baixe fotos, biografia e informa├º├Áes para imprensa."
  },
  hero: {
    tag: "Press Kit Oficial",
    title_prefix: "Zen",
    title_suffix: "Eyer",
    role: "DJ brasileiro bicampe├úo mundial de Zouk Brasileiro",
    subtitle: "Sets cremosos, emocionais e conectados ├á dan├ºa"
  },
  stats: [
  ...
  bio: {
    ...
    p1: (
      <>
        <strong className="text-white">Zen Eyer</strong> (Marcelo Eyer Fernandes) ├® um <strong>DJ brasileiro especializado em Zouk Brasileiro</strong>, bicampe├úo mundial no g├¬nero (2022) e membro da Mensa International. Seu estilo ├║nico, chamado de "<strong>cremosidade</strong>", combina t├®cnica apurada com emo├º├úo profunda, criando sets que s├úo verdadeiras jornadas musicais para os dan├ºarinos.
      </>
    ),
    p2: (
      <>
        Com mais de 10 anos de carreira, Zen Eyer j├í se apresentou em <strong>100+ eventos em 11 pa├¡ses</strong>, incluindo Holanda, Espanha, Rep├║blica Tcheca e Alemanha. Seu repert├│rio ├® 100% focado no Zouk Brasileiro, com influ├¬ncias de kizomba, lambada e black music, sempre priorizando a conex├úo emocional com a dan├ºa.
      </>
    ),
    p3: (
      <>
        Como produtor musical, Zen Eyer cria remixes exclusivos e edi├º├Áes especiais para o floor de Zouk, com mais de <strong>500.000 streams globais</strong>. ├ë criador do evento <strong>reZENha</strong> e da comunidade <strong>Tribo Zen</strong>, que oferece conte├║do exclusivo para amantes do Zouk Brasileiro.
      </>
    ),
    quickStats: [
      ...
      { title: "Conex├úo", desc: "Foco na dan├ºa", icon: <Users size={20} className="text-success" /> },
      { title: "Global", desc: "Presen├ºa internacional", icon: <Globe size={20} className="text-purple-400" /> }
    ]
  },
  media: {
    title: "Material para Imprensa",
    subtitle: "Tudo que voc├¬ precisa para divulga├º├úo e marketing",
    items: [
      { title: "Fotos para Imprensa", desc: "Galeria oficial em alta resolu├º├úo", path: PRESS_LINKS.photos, icon: <ImageIcon size={32} />, isExternal: true },
      { title: "Biografia Completa", desc: "PDF com Bio e Rider T├®cnico", path: PRESS_LINKS.epk, icon: <FileText size={32} />, isExternal: false },
  ...
  gallery: {
    ...
    subtitle: "Imagens em alta resolu├º├úo para uso promocional",
    cta: "Ver Galeria Completa"
  },
  contact: {
    title: "Vamos Criar Algo Incr├¡vel",
    subtitle: "Pronto para elevar seu evento? Entre em contato para discutir bookings ou colabora├º├Áes.",
...
const WHATSAPP_CONFIG = {
  ...
  message: "Ol├í Zen Eyer! Gostaria de conversar sobre uma poss├¡vel colabora├º├úo ou booking. Como podemos prosseguir?"
};
...
const MediaKitCard = memo<{ icon: React.ReactNode; title: string; description: string; path: string; isExternal?: boolean }>(({ icon, title, description, path, isExternal }) => (
  <motion.a
    href={path}
    download={!isExternal} // S├│ tenta baixar se n├úo for link externo
    target="_blank"
