...
const ZenTribePage = lazyWithRetry(() => import('../pages/ZenTribePage'));
const MediaPage = lazyWithRetry(() => import('../pages/MediaPage'));
const PressKitPage = lazyWithRetry(() => import('../pages/PressKitPage'));
const PressKitDownloadPage = lazyWithRetry(() => import('../pages/PressKitDownloadPage'));
...
const MyAccountPage = lazyWithRetry(() => import('../pages/MyAccountPage'));
const FAQPage = lazyWithRetry(() => import('../pages/FAQPage'));
const PhilosophyPage = lazyWithRetry(() => import('../pages/PhilosophyPage'));
...
const CodeOfConductPage = lazyWithRetry(() => import('../pages/CodeOfConductPage'));
const SupportArtistPage = lazyWithRetry(() => import('../pages/SupportArtistPage'));
const TicketsPage = lazyWithRetry(() => import('../pages/TicketsPage'));
const TicketsCheckoutPage = lazyWithRetry(() => import('../pages/TicketsCheckoutPage'));
const ResetPasswordPage = lazyWithRetry(() => import('../pages/ResetPasswordPage'));
const ZenLinkPage = lazyWithRetry(() => import('../pages/ZenLinkPage').then(m => ({ default: m.ZenLinkPage })));
const ZoukPersonaQuizPage = lazyWithRetry(() => import('../pages/ZoukPersonaQuizPage'));
