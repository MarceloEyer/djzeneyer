...
const DashboardPage: React.FC = () => {
  ...
  // ✅ Calcular streak (exemplo: user meta field ou GamiPress custom)
  // TODO: Implementar tracking real de streak no WordPress
  const streakDays = user.streak_days || 0;
  
  // ✅ Tribe Friends (placeholder por enquanto)
  const tribeFriends = 12;
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <div className="card p-8 bg-gradient-to-br from-accent/20 to-primary/20 border-2 border-accent/30 hover:scale-[1.02] transition-all cursor-pointer group"
            ...
            <p className="text-white/80 mb-4">
              Discover upcoming shows and exclusive events
            </p>
          ...
          <div className="card p-8 bg-gradient-to-br from-success/20 to-primary/20 border-2 border-success/30 hover:scale-[1.02] transition-all cursor-pointer group"
            ...
            <p className="text-white/80 mb-4">
              Explore exclusive tracks and mixes
            </p>
        ...
        >
          ...
          <div className="card p-4 md:p-6 hover:scale-105 transition-transform">
            ...
            <div className="text-2xl md:text-3xl font-black mb-1">{tribeFriends}</div>
            ...
            <div className="card p-6">
              ...
              {safeAchievements.length > 0 ? (
                <div className="space-y-4">
                  {safeAchievements.slice(0, 3).map((ach, i) => (
                    <motion.div
                      key={ach.id || i}
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="font-semibold truncate">
                          Unlocked <span className="text-primary">{ach.title}</span>
                        </div>
                        <div className="text-sm text-white/60">Recently achieved</div>
                      </div>
                      <div className="text-success font-bold text-sm flex-shrink-0">+{ach.points || 10} XP</div>
                    </motion.div>
                  ))}
                </div>
              ) : (
