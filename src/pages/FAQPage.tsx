...
// ============================================================================
// FAQ PAGE - VERSÃO REFATORADA FINAL
// ============================================================================
...
      },
      {
        question: 'Qual é a frase famosa do DJ Zen Eyer?',
        answer: 'A frase famosa (catchphrase) oficial do Zen Eyer é: <strong>"A pressa é inimiga da cremosidade"</strong>. Esta frase reflete sua filosofia de mixagem, onde a transição perfeita e a conexão emocional são mais importantes do que a velocidade ou a complexidade técnica vazia. Ele aplica essa filosofia tanto na produção musical quanto em seus sets ao vivo, garantindo uma experiência suave e fluida para os dançarinos.'
      },
      {
