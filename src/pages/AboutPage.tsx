 ...
 * @description Página "Sobre" do DJ Zen Eyer com biografia, conquistas e filosofia
 * @route /about
 ...
 *
 * FUNCIONALIDADES:
 * - Biografia completa do DJ Zen Eyer
 * - Timeline de conquistas (2015-2025)
 * - Stats visuais (países, eventos, streams)
 * - Filosofia musical
 * - Schema.org Person (Google Knowledge Panel)
 * - Animações Framer Motion
 *
 * SEO:
 * - H1 visível e semântico
 * - Schema.org Person válido com hasCredential
...
const AboutPage: React.FC = () => {
    ...
    "hasCredential": [
      {
        ...
        "name": "World Champion Brazilian Zouk DJ 2022 - Best Zouk Remix"
      },
      {
        "@type": "EducationalOccupationalCredential",
        "credentialCategory": "professional achievement",
        "name": "World Champion Brazilian Zouk DJ 2022 - Performance Art"
      }
    ],
    "knowsAbout": [
      "Brazilian Zouk",
  ...
  return (
    <>
      <SEO
        title="About DJ Zen Eyer - Brazilian Zouk World Champion & Mensa Member"
        description="DJ Zen Eyer is a two-time world champion Brazilian Zouk DJ and music producer, Mensa International member, with 100+ international performances across 11 countries and 500K+ streams."
        image="https://djzeneyer.com/wp-content/uploads/2024/dj-zen-eyer-profile.jpg"
        type="profile"
        keywords="DJ Zen Eyer, Brazilian Zouk DJ, World Champion DJ, Mensa DJ, Zouk Music Producer, International DJ, Dance Music"
      />
