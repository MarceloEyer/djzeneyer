...
const StatCard = memo<{ icon: React.ReactNode; number: string; label: string; color: string }>(
  ({ icon, number, label, color }) => (
    ...
    >
      <div className="text-white inline-block p-4 bg-white/10 rounded-full mb-4">{icon}</div>
...
const PressKitPage: React.FC = () => {
  ...
  const RELEVANT_LINKS = useMemo(
    () => [
      ...
      {
        name: t('social.wikidata'),
        url: 'https://www.wikidata.org/wiki/Q136551855',
        icon: <Globe size={20} />,
      },
      {
        name: t('social.discogs'),
        url: 'https://www.discogs.com/artist/16872046',
        icon: <Database size={20} />,
      },
      {
        name: t('social.resident_advisor'),
        url: 'https://pt-br.ra.co/dj/djzeneyer',
        ...
        <div className="relative h-[80vh] min-h-[600px] flex items-center overflow-hidden">
          <div className="absolute inset-0">
            <img
              ...
              alt="DJ Zen Eyer Official EPK Background"
          ...
          <div className="container mx-auto px-4">
            ...
            >
              <div className="text-center mb-16 px-4">
                <h2 className="text-5xl font-black font-display mb-6 uppercase tracking-tighter">
                  Line-ups <span className="text-primary">Internacionais</span>
                </h2>
                <p className="text-xl text-white/50 max-w-2xl mx-auto">
                  Alguns dos palcos onde o Zouk Brasileiro encontrou o flow sem pressa.
                </p>
              </div>
              ...
              <div className="text-center mt-12 px-4">
                <p className="text-white/30 font-display italic text-lg">
                  + tour mundial contínua cobrindo Américas, Europa e Oceania.
                </p>
              </div>
            </motion.div>
          </div>
            ...
            >
              <div className="text-center mb-16">
                <h2 className="text-5xl font-black font-display mb-6">
                  {t('presskit.media.title')}
                </h2>
                <p className="text-xl text-white/50 max-w-2xl mx-auto">
                  {t('presskit.media.subtitle')}
                </p>
              </div>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
                {[
                  {
                    src: '/images/artist/brazilian-zouk-dance-embrace.jpg',
                    alt: 'Brazilian Zouk Dance Embrace',
                  },
                  {
                    src: '/images/artist/dj-zen-eyer-performing-live.jpg',
                    alt: 'DJ Zen Eyer Performing Live',
                  },
                  {
                    src: '/images/artist/dj-zen-eyer-club-performance.jpg',
                    alt: 'DJ Zen Eyer Club Performance',
                  },
                  {
                    src: '/images/artist/dj-zen-eyer-winner-trophy.jpg',
                    alt: 'DJ Zen Eyer Winner Trophy',
                  },
                  {
                    src: '/images/artist/dj-zen-eyer-beach-brazilian-zouk.png',
                    alt: 'DJ Zen Eyer Beach Zouk',
                  },
                  {
                    src: '/images/artist/dj-zen-eyer-nature-portrait.jpg',
                    alt: 'DJ Zen Eyer Nature Portrait',
                  },
                ].map((photo, i) => (
                  <motion.div
                    key={i}
          ...
          <div className="container mx-auto px-4">
            ...
            >
              <div className="bg-gradient-to-br from-primary/10 via-surface/50 to-accent/10 rounded-[3rem] p-16 border border-white/10 shadow-3xl">
                <h2 className="text-5xl md:text-6xl font-black font-display mb-8 uppercase tracking-tighter">
                  {t('presskit.contact.title')}
                </h2>
                <p className="text-xl text-white/60 mb-12 max-w-2xl mx-auto leading-relaxed">
                  {t('presskit.contact.subtitle')}
                </p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                  ...
                  <a
                    href={ARTIST.social.instagram.url}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="btn btn-outline btn-lg flex items-center justify-center gap-3"
                  >
                ...
                <div className="mt-16 pt-10 border-t border-white/10">
                  <div className="grid md:grid-cols-3 gap-10 text-left mb-12">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <div className="font-bold text-white mb-1 uppercase tracking-wider text-xs">
                          {t('presskit.contact.base')}
                        </div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <div className="font-bold text-white mb-1 uppercase tracking-wider text-xs">
                          {t('presskit.contact.availability')}
                        </div>
                        <div className="text-white/60">
                          {t('presskit.contact.availability_value')}
                        </div>
                      </div>
                    </div>
                    <div className="flex items-start gap-4">
