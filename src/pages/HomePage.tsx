// src/pages/HomePage.tsx - VERSÃO FINAL OTIMIZADA (HEADLESS SEO + PERFORMANCE)
...
import { HeadlessSEO, getHrefLangUrls } from '../components/HeadlessSEO'; // Adicionado getHrefLangUrls

// ============================================================================
// CONSTANTES DE DADOS E ANIMAÇÃO (MOVIDAS PARA FORA DO COMPONENTE)
// ============================================================================
...
// ============================================================================
// COMPONENTE PRINCIPAL (COM ESCOPO LIMPO)
// ============================================================================
...
        isHomepage={true}
        hrefLang={getHrefLangUrls(currentPath, currentUrl)} // Hreflang SSOT
      />
...
            variants={ITEM_VARIANTS} // Usando ITEM_VARIANTS global
          >
            <h2 
              id="features-heading"
...
            variants={CONTAINER_VARIANTS} // Usando CONTAINER_VARIANTS global
            initial="hidden" 
            whileInView="visible" 
            viewport={{ once: true, amount: 0.2 }}
          >
            {FEATURES_DATA.map(feature => ( // Usando FEATURES_DATA global
              <FeatureCard
                key={feature.id}
                icon={feature.icon}
