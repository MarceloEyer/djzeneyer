// src/pages/HomePage.tsx - VERSÃO FINAL (SEM PLAYER INTERNO)

import React from 'react'; // Removido lazy/Suspense pois não estamos carregando player
import { Link } from 'react-router-dom';
import { motion, Variants } from 'framer-motion';
import { useTranslation, Trans } from 'react-i18next';
import { PlayCircle, Calendar, Users, Music, Award } from 'lucide-react';
// Removido useMusicPlayer - Site mais leve e rápido
import { HeadlessSEO, getHrefLangUrls } from '../components/HeadlessSEO';

// ============================================================================
// CONSTANTES DE DADOS E ANIMAÇÃO
// ============================================================================
...
const HomePage: React.FC = () => {
  ...
  const currentPath = '/';
  const currentUrl = 'https://djzeneyer.com';

  return (
    <>
      <HeadlessSEO 
        title={`${t('home_page_title')} | World Champion Brazilian Zouk DJ 2022`}
        description="DJ Zen Eyer - 2022 World Champion Brazilian Zouk DJ. Certified Jack & Jill DJ. Book now for international events. Official music on SoundCloud, Spotify & YouTube."
        url={currentUrl}
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <div className="mt-10 flex flex-wrap gap-4 justify-center">
              {/* BOTÃO ATUALIZADO: Link externo para SoundCloud ou Spotify */}
              <a 
                href="https://soundcloud.com/djzeneyer" 
                target="_blank"
                rel="noopener noreferrer"
                className="btn btn-primary btn-lg flex items-center gap-2" 
                aria-label="Listen to DJ Zen Eyer sets on SoundCloud"
              >
                <PlayCircle size={22} aria-hidden="true" />
                <span>{t('play_featured_mix', 'Listen on SoundCloud')}</span>
              </a>
