...
- **Nome alternativo oficial:** `DJ Zen Eyer`.
- **Nome alternativo proibido:** `Zen Ayer` NÃO deve constar em `alternateName`, nomes alternativos canônicos ou metadados estruturados. Só pode aparecer como grafia incorreta comum em FAQ/copy explicativa, sempre deixando claro que não é nome oficial nem nome alternativo.
- **Tautologia:** Evite descrições como "Zen Eyer, também conhecido como Zen Eyer". Se o nome alternativo for o mesmo que o nome canônico, não o liste como `alternateName`.
