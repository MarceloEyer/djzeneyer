...
- **Zoukology article URL:** nunca adicionar ao `sameAs` do artista. É um artigo com authorship de Zen Eyer, não uma página de identidade do artista. Schema correto: `author` no schema do artigo, `publisher` como Zoukology.
