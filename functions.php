 ...
 * v6.0.0 - Segurança, JWT, GamiPress, MailPoet, Bolt.new
 */
...
add_action('wp_enqueue_scripts', function () {
    ...
    wp_enqueue_script('djzeneyer-react', get_template_directory_uri() . '/dist/assets/index.js', [], '6.0.0', true);
    wp_enqueue_style('djzeneyer-react-styles', get_template_directory_uri() . '/dist/assets/index.css', [], '6.0.0');
...
add_filter('simple_jwt_login_payload_data', function ($payload, $user) {
