...
 * v6.0.1 - JWT Hook Fix para plugin Nicu Micle
 */
...
    wp_enqueue_script('djzeneyer-react', get_template_directory_uri() . '/dist/assets/index.js', [], '6.0.1', true);
    wp_enqueue_style('djzeneyer-react-styles', get_template_directory_uri() . '/dist/assets/index.css', [], '6.0.1');
...
add_filter('simple_jwt_login_jwt_payload_auth', function($payload, $request) {
    if (isset($request['email'])) {
        ...
        if ($user) {
            ...
            // Adicionando os dados do GamiPress, como no seu arquivo original
