...
function gamipress_parse_log_pattern( $log_pattern = '',  $log_data = array(), $log_meta = array()) {
    ...
    // Add more user tags
    $gamipress_pattern_replacements['{user_email}'] = ( $user ? $user->user_email : '' );
    $gamipress_pattern_replacements['{user_login}'] = ( $user ? $user->user_login : '' );
    $gamipress_pattern_replacements['{user_nicename}'] = ( $user ? $user->user_nicename : '' );
    $gamipress_pattern_replacements['{user_first_name}'] = ( $user ? $user->first_name : '' );
    $gamipress_pattern_replacements['{user_last_name}'] = ( $user ? $user->last_name : '' );
