...
| **País count = 15+, continentes = 4** | SSOT: `ARTIST.stats.countriesPlayed` e `continentsPlayed` em `artistData.ts`. 4 continentes verificados: América do Sul, América do Norte, Europa, Oceania (One Zouk Congress, Austrália). Nunca usar contagem abaixo de 15 países. |
