...
> **Gerado automaticamente** por `scripts/generate-api-inventory.mjs` em 2026-09-20.
> Não edite manualmente. Para o mapa curado, veja [`.context/API.md`](./API.md).

Total de endpoints encontrados: **51**
...
## `zen-private-music/v1`

| Método | Rota | Callback | Permission | Arquivo |
|--------|------|----------|------------|---------|
| `GET` | `/tracks` | `rest_list_tracks` | `[__CLASS__], rest_is_authenticated` | `plugins/zen-private-music-delivery/includes/class-zen-private-music.php` |
| `GET` | `/tracks/(?P<id>\d+)/download` | `rest_download_track` | `[__CLASS__], rest_is_authenticated` | `plugins/zen-private-music-delivery/includes/class-zen-private-music.php` |
