...
<head>
  ...
  <meta name="ai:summary" content="<?php echo esc_attr(djz_config('site.description')); ?>">
  ...
  <!-- PWA -->
  <link rel="manifest" href="<?php echo esc_url(get_template_directory_uri()); ?>/dist/manifest.webmanifest">
