...
| `check-utf8-content.mjs` | `npm run utf8:check` | CI. Detecta mojibake em arquivos rastreados de código, conteúdo e contexto. |
| `check-performance-budget.mjs` | `npm run perf:budget` | CI pós-build. Valida orçamentos de Lighthouse/bundle. Baseline atualizado em `lighthouserc.cjs`. |
